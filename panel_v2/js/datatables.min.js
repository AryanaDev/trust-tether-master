 ...
 *   https://datatables.net/download/#dt/dt-1.13.2/b-2.3.4/sb-1.4.0/sl-1.6.0
 *
 * Included libraries:
 *   DataTables 1.13.2, Buttons 2.3.4, SearchBuilder 1.4.0, Select 1.6.0
 */
        ...
        He =
            (e("columns()", function (n, a) {
                ...
                (C.defaults = {
                    ...
                    oClasses: {},
                    oLanguage: {
                        oAria: { sSortAscending: ": مرتب سازی ستون عمودی", sSortDescending: ": مرتب کردن ستون افقی" },
                        ...
                        sInfoEmpty: "نمایش  0 از 0 تا 0 ورودی ها",
                        sInfoFiltered: "(فیلتر از _MAX_ ورودی ها)",
                        sInfoPostFix: "",
                        sDecimal: "",
                        sThousands: ",",
                        sLengthMenu: "_MENU_",
                ...
                (C.ext = p = {
                    buttons: {},
                    classes: {},
                    build: "dt/dt-1.13.2/b-2.3.4/sb-1.4.0/sl-1.6.0",
                    errMode: "alert",
                    feature: [],
                    search: [],
...
!(function (e) {
    ...
    v.extend(k.prototype, {
        ...
        _buildButton: function (n, t, e, o) {
            ...
            if (
                (!e && o && f ? (c = p) : !e && t && d.button && (c = d.button),
                    !e && o && f.buttonLiner ? (u = f.buttonLiner) : !e && t && d.buttonLiner && (u = d.buttonLiner),
            ...
            !1 === o
                ...
                ("container" !== b.span && "dt-container" !== b.align) || ((g = g.parent()), s.css("width", n.width())),
                    "absolute" === d
                        ...
                        ("button-right" !== b.align && !s.hasClass(b.rightAlignClassName)) || (c = t.left - u.width + g.outerWidth()),
                        ("dt-container" !== b.align && "container" !== b.align) || ((c = c < t.left ? -t.left : c) + u.width > r.width && (c = r.width - u.width)),
                        a.left + c + u.width > v(m).width() && (c = v(m).width() - u.width - a.left),
                        n.left + c < 0 && (c = -n.left),
                        a.top + p + u.height > v(m).height() + v(m).scrollTop() && (p = t.top - u.height - u.marginTop - u.marginBottom),
                        ...
                        (h = !1),
                            v("body")
                                .on("click.dtb-collection", function (t) {
                                    ...
                                    (!v(t.target).parents()[n]().filter(o).length && !v(e).hasClass("dt-buttons")) || v(t.target).hasClass("dt-button-background")) &&
                                    i();
                                })
                                ...
                                .on("keydown.dtb-collection", function (t) {
                                    var n = v("a, button", o),
                                        e = y.activeElement;
                                    9 === t.keyCode &&
                                    (-1 === n.index(e) ? (n.first().focus(), t.preventDefault()) : t.shiftKey ? e === n[0] && (n.last().focus(), t.preventDefault()) : e === n.last()[0] && (n.first().focus(), t.preventDefault()));
                                });
                    }, 0));
        },
    }),
        ...
        (k.buttonSelector = function (t, n) {
            for (
                var c = [],
                    u = function (t, n, e) {
                        for (var o, i, s = 0, r = n.length; s < r; s++) (o = n[s]) && (t.push({ node: o.node, name: o.conf.name, idx: (i = e !== x ? e + s : s + "") }), o.buttons) && u(t, o.buttons, i + "-");
                    },
                    d = function (t, n) {
                        var e = [],
                            o =
                        ...
                        else if (null === t || t === x || "*" === t) for (s = 0, r = e.length; s < r; s++) c.push({ inst: n, node: e[s].node });
        ...
        v.extend(w, {
            ...
            pageLength: function (t) {
                ...
                return {
                    extend: "collection",
                    text: function (t) {
                        return t.i18n("buttons.pageLength", { "-1": "نمایش همه ردیف ها", _: "نمایش %d ردیف ها" }, t.page.len());
                    },
    ...
    var i,
        ...
        r = function (t) {
            t = s(t.title);
            return null === t ? null : -1 !== t.indexOf("*") ? t.replace("*", v("head > title").text() || "داده های صادر شده") : t;
        },
        a = function (t, n, e) {
            n = s(n);
    ...
    "function" == typeof define && define.amd
        ...
        : "object" == typeof exports
            ? (module.exports = function (e, t) {
                return (
                    (e = e || window),
                    (t = t || ("undefined" != typeof window ? require("jquery") : require("jquery")(e))).fn.dataTable || require("datatables.net-dt")(e, t),
    ...
    return (
        (u = function (e, t, n, a) {
            ...
            "function" == typeof define && define.amd
                ...
                : "object" == typeof exports
                    ? (module.exports = function (e, t) {
                        return (e = e || n), (t = t && t.fn.dataTable ? t : require("datatables.net-dt")(e, t).$).fn.dataTable.Buttons || require("datatables.net-buttons")(e, t), u(t, 0, e.document);
                    })
                    : u(jQuery),
            e
    );
...
!(function (e) {
    "function" == typeof define && define.amd
        ...
        : "object" == typeof exports
            ? (module.exports = function (t, i) {
                return (t = t || window), (i = i || ("undefined" != typeof window ? require("jquery") : require("jquery")(t))).fn.dataTable || require("datatables.net")(t, i), e(i, t, t.document);
            })
            : e(jQuery, window, document);
})(function (s, l, t, V) {
    "use strict";
    ...
    function w(t, i, e, n, s, r) {
        var o = this;
        if ((void 0 === n && (n = 0), void 0 === s && (s = 1), void 0 === r && (r = V), !u || !u.versionCheck || !u.versionCheck("1.10.0"))) throw new Error("SearchPane requires DataTables 1.10 or newer");
        (this.classes = I.extend(!0, {}, w.classes)), (this.c = I.extend(!0, {}, w.defaults, I.fn.dataTable.ext.searchBuilder, i));
        i = this.c.i18n;
        if (
            ((this.s = { condition: V, conditions: {}, data: V, dataIdx: -1, dataPoints: [], dateFormat: !1, depth: s, dt: t, filled: !1, index: n, origData: V, preventRedraw: !1, serverData: r, topGroup: e, type: "", value: [] }),
                (this.dom = {
        ...
        if ((void 0 === n && (n = 0), void 0 === s && (s = !1), void 0 === r && (r = 1), void 0 === o && (o = V), d && d.versionCheck && d.versionCheck("1.10.0")))
            return (
                (this.classes = a.extend(!0, {}, g.classes)),
                    ...
                    (this.s = { criteria: [], depth: r, dt: t, index: n, isChild: s, logic: V, opts: i, preventRedraw: !1, serverData: o, toDrop: V, topGroup: e }),
                    (this.dom = {
        ...
        (w._escapeHTML = function (t) {
            ...
            (w.prototype.search = function (t, i) {
                ...
                if (this.s.condition !== V && e !== V) {
                    ...
                    if (
                        ("filter" !== this.c.orthogonal.search && (n = (t = this.s.dt.settings()[0]).oApi._fnGetCellData(t, i, this.s.dataIdx, "string" == typeof this.c.orthogonal ? this.c.orthogonal : this.c.orthogonal.search)),
                        "array" === this.s.type)
                    ) {
            ...
            (w.prototype.getDetails = function (t) {
                if ((void 0 === t && (t = !1), null === this.s.type || !this.s.type.includes("num") || ("" === this.s.dt.settings()[0].oLanguage.sDecimal && "" === this.s.dt.settings()[0].oLanguage.sThousands))) {
                    if (null !== this.s.type && t)
                        if (this.s.type.includes("date") || this.s.type.includes("time")) for (i = 0; i < this.s.value.length; i++) null === this.s.value[i].match(/^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])$/g) && (this.s.value[i] = "");
                            ...
                            for (i = 0; i < this.s.value.length; i++)
                                ...
                                (this.s.value[i] = f().DateTime.fromFormat(this.s.value[i], this.s.dateFormat).toFormat("yyyy-MM-dd HH:mm:ss"));
                } else
            ...
            (w.prototype._populateCondition = function () {
                ...
                if (0 === i) {
                    ...
                    var s = this.s.dt.settings()[0].oLanguage.sDecimal,
                        r =
                            ("" !== s && this.s.type.indexOf(s) === this.s.type.length - s.length && (this.s.type.includes("num-fmt") || this.s.type.includes("num")) && (this.s.type = this.s.type.replace(s, "")),
                    ...
                    for (var o, a = 0, d = Object.keys(r); a < d.length; a++)
                        ...
                        ((o = e[n]),
                            this.s.serverData && this.s.serverData[o.data]
                                ? ((r[c].init = w.initSelectSSP), (r[c].inputValue = w.inputValueSelect), (r[c].isInputValid = w.isInputValidSelect))
                                : ((r[c].init = w.initInput), (r[c].inputValue = w.inputValueInput), (r[c].isInputValid = w.isInputValidInput))),
                            (this.s.conditions[c] = r[c]),
                        "function" == typeof (y = r[c].conditionName) && (y = y(this.s.dt, this.c.i18n)),
                            t.push(I("<option>", { text: y, value: c }).addClass(this.classes.option).addClass(this.classes.notItalic)));
                } else {
                    ...
                    for (var l = 0, u = Object.keys(this.s.conditions); l < u.length; l++) {
                        var c = u[l],
                            h = ("function" == typeof (y = this.s.conditions[c].conditionName) && (y = y(this.s.dt, this.c.i18n)), I("<option>", { text: y, value: c }).addClass(this.classes.option).addClass(this.classes.notItalic));
                ...
                if ((this.dom.data.empty().append(this.dom.dataTitle), 0 === this.s.dataPoints.length))
                    this.s.dt.columns().every(function (t) {
                        if (!0 === o.c.columns || o.s.dt.columns(o.c.columns).indexes().toArray().includes(t)) {
                            ...
                            n ||
                            ((e = { index: t, origData: (i = o.s.dt.settings()[0].aoColumns[t]).data, text: (i.searchBuilderTitle === V ? i.sTitle : i.searchBuilderTitle).replace(/(<([^>]+)>)/gi, "") }),
                    ...
                    for (var i = this, t = 0, e = this.s.dataPoints; t < e.length; t++)
                        !(function (e) {
                            i.s.dt.columns().every(function (t) {
                                ...
                                (i.searchBuilderTitle === V ? i.sTitle : i.searchBuilderTitle).replace(/(<([^>]+)>)/gi, "") === e.text && ((e.index = t), (e.origData = i.data));
                            });
                            ...
                            i.s.data === e.text && ((i.s.dataIdx = e.index), i.dom.dataTitle.removeProp("selected"), t.prop("selected", !0), i.dom.data.removeClass(i.classes.italic)), i.dom.data.append(t);
                        })(e[t]);
            }),
            (w.prototype._populateValue = function (i) {
                ...
                (this.s.filled = this.s.conditions[this.s.condition].isInputValid(this.dom.value, this)),
                    this.setListeners(),
                this.s.preventRedraw || t === this.s.filled || (this.s.dt.page.info().serverSide || this.s.dt.draw(), this.setListeners());
            }),
            ...
            (w.initSelect = function (e, t, n, i) {
                ...
                for (
                    ...
                    var h = c[u],
                        ...
                        m = { filter: "string" == typeof p ? p.replace(/[\r\n\u2028]/g, " ") : p, index: h, text: o.oApi._fnGetCellData(o, h, s, "string" == typeof e.c.orthogonal ? e.c.orthogonal : e.c.orthogonal.display) },
                        f =
                            ("array" === e.s.type && ((m.filter = Array.isArray(m.filter) ? m.filter : [m.filter]), (m.text = Array.isArray(m.text) ? m.text : [m.text])),
                                function (t, i) {
                                    ...
                                    (t = I("<option>", { type: Array.isArray(t) ? "Array" : "String", value: t })
                                        ...
                                        (i = t.val());
                                    -1 === d.indexOf(i) &&
                                    (d.push(i), l.push(t), null !== n && Array.isArray(n[0]) && (n[0] = n[0].sort().join(",")), null !== n) &&
                                    t.val() === n[0] &&
                ...
                var i = this,
                    ...
                    r = [
                        ...
                        I("<input/>")
                            ...
                            .on(
                                "input.dtsb keypress.dtsb",
                                e.c.enterSearch || (e.s.dt.settings()[0].oInit.search !== V && e.s.dt.settings()[0].oInit.search.return) || null === s
                                    ? function (t) {
                                        t = t.keyCode || t.which;
                                        n(e, i, t);
                                    }
            ...
            (w.isInputValidSelect = function (t) {
                for (var i = !0, e = 0, n = t; e < n.length; e++) {
                    var s = n[e];
                    s.children("option:selected").length === s.children("option").length - s.children("option." + w.classes.notItalic).length &&
            ...
            (w.updateListener = function (t, i, e) {
                ...
                if (((t.s.filled = n.isInputValid(t.dom.value, t)), (t.s.value = n.inputValue(t.dom.value, t)), t.s.filled)) {
                    ...
                    ((t.c.enterSearch || (t.s.dt.settings()[0].oInit.search !== V && t.s.dt.settings()[0].oInit.search.return)) && 13 !== e) || t.s.dt.draw(),
            ...
            (w.defaults = {
                ...
                i18n: {
                    add: "اضافه کردن شرط",
                    button: { 0: "سازنده جستجو", _: "سازنده جستجو (%d)" },
                    clearAll: "حذف همه",
                    condition: "وضعیت",
                    data: "اطلاعات",
                    delete: "&times",
                    deleteTitle: "حذف قانون فیلترینگ",
                    left: "<",
                    leftTitle: "معیارهای بیرونی",
                    logicAnd: "و",
                    logicOr: "یا",
                    right: ">",
                    rightTitle: "معیارهای تورفتگی",
                    title: { 0: "سازنده جستجوی سفارشی", _: "سازنده جستجوی سفارشی (%d)" },
                    value: "Value",
                    valueJoiner: "and",
                },
                logic: "و",
                    ...
                    if (
                        ((this.s.logic = t.logic),
                            this.dom.logic
                                .children()
                                .first()
                                .html("OR" === this.s.logic ? this.s.dt.i18n("searchBuilder.logicOr", this.c.i18n.logicOr) : this.s.dt.i18n("searchBuilder.logicAnd", this.c.i18n.logicAnd)),
            ...
            (g.prototype.setupLogic = function () {
                if ((this.dom.logicContainer.remove(), this.dom.clear.remove(), this.s.criteria.length < 1)) this.s.isChild || (this.dom.container.trigger("dtsb-destroy"), this.dom.container.css("margin-left", 0));
                    ...
                    var n = this.dom.container.outerHeight() - 1,
                        ...
                        n = n.top,
                        s = a(s).offset().top;
                    this.dom.logicContainer.offset({ top: n - (n - s) }), this.dom.clear.outerHeight(this.dom.logicContainer.height()), this._setClearListener();
                }
            }),
            ...
            (g.prototype.addCriteria = function (t) {
                for (
                    var i = null === (t = void 0 === t ? null : t) ? this.s.criteria.length : t.s.index,
                        ...
                        n = (null !== t && ((e.c = t.c), (e.s = t.s), (e.s.depth = this.s.depth), (e.classes = t.classes)), e.populate(), !1),
                        s = 0;
            ...
            (g.prototype._addPrevGroup = function (t) {
                ...
                this.s.criteria.push({ criteria: e, index: i, logic: e.s.logic }), e.rebuild(t), (this.s.criteria[i].criteria = e), this.s.topGroup.trigger("dtsb-redrawContents"), this._setGroupListeners(e);
            }),
            ...
            (g.prototype._setup = function () {
                this.setListeners(),
                    ...
                    this.dom.logic
                        .children()
                        .first()
                        .html("OR" === this.c.logic ? this.s.dt.i18n("searchBuilder.logicOr", this.c.i18n.logicOr) : this.s.dt.i18n("searchBuilder.logicAnd", this.c.i18n.logicAnd)),
            ...
            (g.prototype._toggleLogic = function () {
                "OR" === this.s.logic
                    ? ((this.s.logic = "AND"), this.dom.logic.children().first().html(this.s.dt.i18n("searchBuilder.logicAnd", this.c.i18n.logicAnd)))
            ...
            (g.version = "1.1.0"),
            (g.classes = { add: "dtsb-add", button: "dtsb-button", clearGroup: "dtsb-clearGroup", greyscale: "dtsb-greyscale", group: "dtsb-group", inputButton: "dtsb-iptbtn", logic: "dtsb-logic", logicContainer: "dtsb-logicContainer" }),
            (g.defaults = {
                columns: !0,
                conditions: {
            ...
            (n.prototype._setUp = function (t) {
                ...
                (null !== (t = this.s.dt.state.loaded()) && t.searchBuilder !== V
                    ...
                    this.s.dt.page.info().serverSide || (t.page ? this.s.dt.page(t.page).draw("page") : this.s.dt.scroller && t.scroller && this.s.dt.scroller().scrollToRow(t.scroller.topRow)),
                        this.s.topGroup.setListeners())
                    : !1 !== this.c.preDefined && ((this.c.preDefined = this._applyPreDefDefaults(this.c.preDefined)), this.rebuild(this.c.preDefined))),
            ...
            (n.version = "1.4.0"),
            (n.classes = { button: "dtsb-button", clearAll: "dtsb-clearAll", container: "dtsb-searchBuilder", inputButton: "dtsb-iptbtn", title: "dtsb-title", titleRow: "dtsb-titleRow" }),
            (n.defaults = {
                columns: !0,
                conditions: {
                    date: c.dateConditions,
...
!(function (l) {
    "function" == typeof define && define.amd
        ...
        : "object" == typeof exports
            ? (module.exports = function (e, t) {
                return (e = e || window), (t = t || ("undefined" != typeof window ? require("jquery") : require("jquery")(e))).fn.dataTable || require("datatables.net")(e, t), l(t, e, e.document);
            })
    ...
    function c(o) {
        ...
        t
            ...
            .on("click.dtSelect", s, function (e) {
                ...
                ((c = n.index()),
                    "row" === l ? ((t = c.row), p(e, o, s, "row", t)) : "column" === l ? ((t = n.index().column), p(e, o, s, "column", t)) : "cell" === l && ((t = n.index()), p(e, o, s, "cell", t)),
        ...
        (o._select_init = !0),
            ...
            i.on("draw.dtSelect.dt select.dtSelect.dt deselect.dtSelect.dt info.dt", function () {
                ...
                ((c = s.rows({ selected: !0 }).flatten().length),
                    ...
                    (a = function (e, t, l) {
                        e.append(m('<span class="select-item"/>').append(s.i18n("select." + t + "s", { _: "%d " + t + "s selected", 0: "", 1: "1 " + t + " selected" }, l)));
                    }),
            ...
            i.on("destroy.dtSelect", function () {
                m(i.rows({ selected: !0 }).nodes()).removeClass(i.settings()[0]._select.className), s(i), i.off(".dtSelect"), m("body").off(".dtSelect" + w(i.table().node()));
            });
    }
    function d(e, t, l, s) {
        var c,
            ...
            s = m.inArray(s, n),
            o = m.inArray(l, n);
        e[t + "s"]({ selected: !0 }).any() || -1 !== s ? (o < s && ((c = o), (o = s), (s = c)), n.splice(o + 1, n.length), n.splice(0, s)) : n.splice(m.inArray(l, n) + 1, n.length),
            e[t](l, { selected: !0 }).any() ? (n.splice(m.inArray(l, n), 1), e[t + "s"](n).deselect()) : e[t + "s"](n).select();
    }
    function f(e, t) {
        (!t && "single" !== e._select.style) || ((t = new _.Api(e)).rows({ selected: !0 }).deselect(), t.columns({ selected: !0 }).deselect(), t.cells({ selected: !0 }).deselect());
    }
